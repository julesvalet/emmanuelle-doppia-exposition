...
export const translations = {
  fr: {
    ...
    cart: {
      ...
      promoPlaceholder: 'Saisir votre code',
      promoApply: 'Appliquer',
      promoApplied: 'Code appliqué — votre tirage passe à 1,00 €.',
    ...
    account: {
      account: 'Compte',
      signIn: 'Se connecter',
      openAccount: 'Ouvrir l’espace compte',
      ...
      updatePasswordSubmit: 'Enregistrer le mot de passe',
      ...
      signUpSuccess: 'Compte créé. Vérifiez votre boîte mail pour confirmer votre adresse avant de vous connecter.',
      forgotSuccess: 'Si un compte existe avec cette adresse, un e-mail de réinitialisation vient d’être envoyé.',
  ...
  en: {
    ...
    cart: {
      ...
      promoApply: 'Apply',
      promoApplied: 'Code applied — your print is now €1.00.',
    ...
    account: {
      ...
      signUpSuccess: 'Account created. Check your inbox to confirm your address before signing in.',
      forgotSuccess: 'If an account exists for this address, a reset email has just been sent.',
