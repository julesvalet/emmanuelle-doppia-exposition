...
export const translations = {
  fr: {
    ...
    cart: {
      ...
      promoExpired: 'Ce code promotionnel n’était valable que le 17 août 2026. Il n’est plus disponible.',
      ...
      accountRequiredNotice: 'Un compte est nécessaire pour finaliser votre commande. Connectez-vous ou créez un compte pour continuer.',
      shippingSameAddress: 'Voulez-vous être livré à la même adresse ?',
      shippingUseAddress: 'Utiliser cette adresse',
      shippingAddNew: 'Changer d’adresse / ajouter une nouvelle adresse',
      backToAddresses: 'Retour aux adresses enregistrées',
    },
    account: {
      account: 'Compte',
      signIn: 'Se connecter',
      ...
      ordersTitle: 'Historique de commandes',
      ordersLoading: 'Chargement de vos commandes…',
      ordersEmpty: 'Vous n’avez pas encore passé de commande.',
      orderNumberLabel: 'Commande',
      orderStatusCompleted: 'Payée',
      orderDibondYes: 'Dibond : oui',
      orderDibondNo: 'Dibond : non',
      addressesTitle: 'Mes adresses',
      addressesLoading: 'Chargement de vos adresses…',
      addressesEmpty: 'Aucune adresse enregistrée pour le moment.',
  ...
  en: {
    ...
    cart: {
      ...
      promoExpired: 'This promo code was only valid on 17 August 2026. It is no longer available.',
      ...
      accountRequiredNotice: 'An account is required to complete your order. Sign in or create an account to continue.',
      shippingSameAddress: 'Deliver to the same address?',
      shippingUseAddress: 'Use this address',
      shippingAddNew: 'Change address / add a new one',
      backToAddresses: 'Back to saved addresses',
    },
    account: {
      account: 'Account',
      signIn: 'Sign in',
      ...
      ordersEmpty: 'You haven’t placed an order yet.',
      orderNumberLabel: 'Order',
      orderStatusCompleted: 'Paid',
      orderDibondYes: 'Dibond: yes',
      orderDibondNo: 'Dibond: no',
